...
public class IyzipayResourceV2
{
    ...
    protected static Dictionary<string, string> GetHttpHeadersWithRequestBody(BaseRequestV2 request, string url,
        Options options)
    {
    ...
    protected static Dictionary<string, string> GetHttpHeadersWithUrlParams(BaseRequestV2 request, string url,
        Options options)
    {
        var headers = GetCommonHttpHeaders(request, url, options);
