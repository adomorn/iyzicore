...
public class SubscriptionCustomer : BaseTest
{
    ...
    public void Should_Create_Customer()
    {
        ...
        var response = Customer.Create(createCustomerRequest, _options);
    ...
    public void Should_Update_Customer()
    {
        ...
        var createCustomerResponse = Customer.Create(createCustomerRequest, _options);
        ...
        var response = Customer.Update(updateCustomerRequest, _options);
        PrintResponse(response);
    ...
    public void Should_Retrieve_Customer()
    {
        ...
        var retrieveCustomerRequest = new RetrieveCustomerRequest
        {
            Locale = Locale.TR.ToString(),
            ConversationId = "123456789",
            CustomerReferenceCode = createCustomerResponse.Data.ReferenceCode
        ...
        var response = Customer.Retrieve(retrieveCustomerRequest, _options);
        PrintResponse(response);
    ...
    public void Should_RetrieveAll_Customer()
    {
        ...
        var response = Customer.RetrieveAll(pagingRequest, _options);
        PrintResponse(response);
