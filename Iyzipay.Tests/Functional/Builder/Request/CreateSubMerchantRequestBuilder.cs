...
public sealed class CreateSubMerchantRequestBuilder : BaseRequestBuilder
{
    ...
    {
        var createSubMerchantRequest = new CreateSubMerchantRequest();
    ...
    public CreateSubMerchantRequestBuilder PersonalSubMerchantRequest()
    {
        ...
        _subMerchantType = Iyzicore.Model.SubMerchantType.PERSONAL.ToString();
        _contactName = "John";
        _contactSurname = "Doe";
    ...
    {
        _subMerchantExternalId = RandomGenerator.RandomId;
        _subMerchantType = Iyzicore.Model.SubMerchantType.PRIVATE_COMPANY.ToString();
    ...
    {
        _subMerchantExternalId = RandomGenerator.RandomId;
        _subMerchantType = Iyzicore.Model.SubMerchantType.LIMITED_OR_JOINT_STOCK_COMPANY.ToString();
        _taxOffice = "Tax office";
        _taxNumber = "9261877";
