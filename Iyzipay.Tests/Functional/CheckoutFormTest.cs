...
public class CheckoutFormTest : BaseTest
{
    ...
    public void Should_Initialize_Checkout_Form_For_Standard_Merchant()
    {
        ...
        var request = CreateCheckoutFormInitializeRequestBuilder.Create()
            .Price("0.3")
    ...
    public void Should_Retrieve_Checkout_Form_Result()
    {
        ...
        var retrieveCheckoutFormRequest = RetrieveCheckoutFormRequestBuilder.Create()
            .Token(checkoutFormInitialize.Token)
            .Build();

        var checkoutForm = CheckoutForm.Retrieve(retrieveCheckoutFormRequest, _options);
