...
public class PayWithIyzicoSample : Sample
{
    ...
    public void Should_Initialize_PayWithIyzico()
    {
        ...
        var payWithIyzicoInitialize = PayWithIyzicoInitialize.Create(request, options);
    ...
    {
        var request = new RetrievePayWithIyzicoRequest();
        request.ConversationId = "123456789";
        request.Token = "cb3f2681-e397-473a-931c-2567fd235627";

        var payWithIyzicoResult = PayWithIyzico.Retrieve(request, options);
