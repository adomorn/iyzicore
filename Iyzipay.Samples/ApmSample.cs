...
public class ApmSample : Sample
{
    ...
    {
        var request = new CreateApmInitializeRequest();
        ...
        var apmInitialize = Apm.Create(request, options);
    ...
    {
        var request = new RetrieveApmRequest();
        request.Locale = Locale.TR.ToString();
        request.ConversationId = "123456789";
        request.PaymentId = "1";

        var retrieve = Apm.Retrieve(request, options);
