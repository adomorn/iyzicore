...
public class SubscriptionPlanSample : Sample
{
    ...
    public void Should_Create_Plan()
    {
        ...
        var response = Plan.Create(request, options);
    ...
    public void Should_Update_Plan()
    {
        ...
        var response = Plan.Update(request, options);
        PrintResponse(response);
    ...
    public void Should_Delete_Plan()
    {
        ...
        var response = Plan.Delete(request, options);
        PrintResponse(response);
    ...
    public void Should_Retrieve_Plan()
    {
        ...
        var response = Plan.Retrieve(request, options);
        PrintResponse(response);
    ...
    public void Should_RetrieveAll_Plan()
    {
        ...
        var response = Plan.RetrieveAll(request, options);
        PrintResponse(response);
