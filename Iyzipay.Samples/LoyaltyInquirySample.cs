...
public class LoyaltyInquirySample : Sample
{
    ...
    {
        var request = new LoyaltyInquiryRequest();
        var loyaltyPaymentCard = new LoyaltyPaymentCard();
        ...
        var loyaltyInquiry = LoyaltyInquiry.Create(request, options);

        PrintResponse(loyaltyInquiry);
