...
using Iyzicore.Model.V2.Iyzilink;
...
public class IyziLinkSample : Sample
{
    ...
    {
        var request = new IyziLinkSaveRequest();
        ...
        var response = IyziLink.Create(request, options);
    ...
    {
        var updateRequest = new IyziLinkSaveRequest();
        ...
        updateRequest.Base64EncodedImage =
            "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8H8BwGwAF0QIs4BDpAAAAAABJRU5ErkJggg==";
        ...
        var response = IyziLink.Update("token", updateRequest, options);
        PrintResponse(response);
    ...
    public void Should_Retrieve_IyziLinks_With_Pagination()
    {
        ...
        var response = IyziLink.RetrieveAll(pagingRequest, options);
        PrintResponse(response);
    ...
    {
        var requestV2 = new BaseRequestV2();
        requestV2.Locale = Locale.TR.ToString();
        requestV2.ConversationId = "123456789";

        var response = IyziLink.Retrieve("token", requestV2, options);
        PrintResponse(response);
    ...
    public void Should_Delete_IyziLink()
    {
        ...
        var response = IyziLink.Delete("token", requestV2, options);
        PrintResponse(response);
