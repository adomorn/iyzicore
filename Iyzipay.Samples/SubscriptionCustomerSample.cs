...
public class SubscriptionCustomerSample : Sample
{
    ...
    public void Should_Create_Customer()
    {
        ...
        var response = Customer.Create(createCustomerRequest, options);
    ...
    public void Should_Update_Customer()
    {
        ...
        var response = Customer.Update(updateCustomerRequest, options);
        PrintResponse(response);
    ...
    public void Should_Retrieve_Customer()
    {
        ...
        var response = Customer.Retrieve(retrieveCustomerRequest, options);
        PrintResponse(response);
    ...
    public void Should_RetrieveAll_Customer()
    {
        ...
        var response = Customer.RetrieveAll(pagingRequest, options);
        PrintResponse(response);
